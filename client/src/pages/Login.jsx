...
const Login = () => {
    ...
    return (
        ...
        <form
            ...
            <button type="submit" className="mt-2 w-full h-11 rounded-full text-gray-300 bg-indigo-600 hover:bg-indigo-500 transition " >
                {state === "login" ? "Login" : "Sign up"}
            </button>
            <div class="flex items-center gap-4 w-full my-5">
                <div class="w-full h-px bg-gray-300/90"></div>
                <p class="w-full text-nowrap text-sm text-gray-500/90">or sign in with Google</p>
                <div class="w-full h-px bg-gray-300/90"></div>
            </div>
            <button type="submit" className="mt-2 w-full h-11 rounded-full text-gray-300 bg-transparent transition flex justify-center items-center gap-2 border border-gray-700/90 cursor-pointer"
            >
